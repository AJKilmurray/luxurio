...
import OrangeJuice from "../images/menu-orangeJuice.jpg";
import CranberryJuice from "../images/menu-cranberryJuice.jpg";
import Beer from "../images/menu-beer.jpg";
import Wine from "../images/menu-wine.jpg";
...
export const menuCategories = {
	...
	drinks: {
		...
		menu: [
			...
			{
				id: 6,
				meal: "Granberry Juice",
				desc: "Cranberry juice is the liquid juice of the cranberry, typically manufactured to contain sugar, water, and other fruit juices. Cranberry – a fruit native to North America – is recognized for its bright red color, tart taste, and versatility for product manufacturing.",
				price: 1.49,
			...
			},
			{
				id: 7,
				meal: "Beer",
				desc: "Beer is one of the oldest and most widely consumed alcoholic drinks in the world, and the third most popular drink overall after water and tea. Beer is brewed from cereal grains—most commonly from malted barley, though wheat, maize, rice, and oats are also used.",
				price: 2.99,
				image: Beer,
				servings: 1,
				calories: 50,
			},
			{
				id: 8,
				meal: "Wine",
				desc: "Wine is an alcoholic drink typically made from fermented grapes. Yeast consumes the sugar in the grapes and converts it to ethanol, carbon dioxide and heat. Different varieties of grapes and strains of yeasts are major factors in different styles of wine.",
				price: 3.49,
				image: Wine,
				servings: 1,
				calories: 85,
